    ...
    >
      ...
      >
        ...
        <Slider
          ...
          max={duration}
          onChange={handleSeek}
          style={{ color: "#fff", marginX: "25px", flexGrow: 1 }}
        />
      ...
      >
        ...
        >
          <SkipPreviousIcon style={{ color: "#fff" }} />
        </IconButton>
        <IconButton onClick={onPlayPause}>
          {isPlaying && !loading ? (
            <PauseIcon style={{ color: "#fff", fontSize: "30px" }} />
          ) : !isPlaying && !loading ? (
            <PlayArrowIcon style={{ color: "#fff", fontSize: "30px" }} />
          ) : loading ? (
            <CircularProgress
